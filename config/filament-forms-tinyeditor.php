...
return [
    ...
    */
    ...
    'profiles' => [
        ...
        'default' => [
            'plugins' => 'advlist autoresize fullscreen hr link lists table toc wordcount',
            'toolbar' => 'undo redo removeformat | formatselect fontsizeselect | bold italic | rtl ltr | alignjustify alignright aligncenter alignleft | numlist bullist | forecolor backcolor | blockquote table toc hr |  link  codesample | wordcount fullscreen',
